...
curl -O -L https://dist.apache.org/repos/dist/dev/pulsar/pulsar-client-cpp-${PULSAR_CPP_VERSION}-candidate-3/apache-pulsar-client-cpp-${PULSAR_CPP_VERSION}.tar.gz
